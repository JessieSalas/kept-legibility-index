# The Kept Legibility Index · Protocol v3
...
Ten conditions. Eight body, two codes. Degradations are applied to the rendered
...
- **Grand mean** = unweighted mean of the ten condition cells.
...
- **Pair separability** (secondary, design-tool only): render the 12 confusable
  pairs at 12 px ×4 supersampling; score = mean normalized pixel difference.
  It is a coarse proxy; it never decides a rank.
